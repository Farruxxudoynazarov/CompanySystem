                ...
                <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    ...
                    <form action="{{ route('employee.update', $employee->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input value="{{ $employee->father_name }}"
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        ...
                        <div class="mb-4">
                            ...
                            <input value="{{ $employee->positon }}"
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                id="last_name" name="positon" type="text" placeholder="Director">
                        </div>
                        <div class="mb-4">
                            <label class="block text-gray-700 text-sm font-bold mb-2">
                                Phone number
                            ...
                            <input value="{{ $employee->phone }}"
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                id="last_name" name="phone" type="tel" placeholder="+998883094848">
                        </div>
                        <div class="mb-4">
                            <label class="block text-gray-700 text-sm font-bold mb-2">
                                Passport number
                            </label>
                            <input value="{{ $employee->passport_number }}"
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        ...
                        <div class="mb-4">
                            <label for="company_id"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kompaniyangiz</label>
                            <select name="company_id" id="company_id">
                                @foreach ($companies as $company)
                                <option value="{{ $company['id'] }}" {{ $employee->company_id == $company['id'] ?
                                    'selected' : '' }}>
                                    {{ $company['name'] }}
                                </option>
                                @endforeach
